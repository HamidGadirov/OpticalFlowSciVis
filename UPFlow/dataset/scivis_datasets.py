...
# kitti_flow_dir = '../../FlowSciVis/Datasets'
...
class kitti_flow:
    class Evaluation_bench():
        ...
        def __init__(self, name, if_gpu=True, batch_size=1):
            ...
            self.loader = tools.data_prefetcher(self.dataset, batch_size=batch_size, shuffle=False, num_workers=1, pin_memory=True, drop_last=False)
